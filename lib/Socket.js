...
Socket.prototype._initiate_send_next = function () {
    ...
    if (this._requestContext.asyncPending('res') || !this._requestContext.requestRead && !this._requestContext.upgrade) {
        // Another response async operation is pending or the request is a regular request that 
        // has not been fully read yet.
...
Socket.prototype.resume = function () {
    ...
    if (this._paused) {
        if (!this._requestContext.asyncPending('req') && !this._requestContext.requestRead) {
