...
util.inherits(ServerRequest, Stream.Readable);

/****** JPW Not sure we need these routines *****/

ServerRequest.prototype.read = function (n) {
    if (!this._consuming)
...
ServerRequest.prototype._read = function (n) {
