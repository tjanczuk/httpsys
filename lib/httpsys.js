...
Server.prototype.listen = function (port, hostname, callback) {
    ...
    try {
        ...
        servers[this._nativeServer] = this;
    }
    catch (e) {
...
Server.prototype.close = function () {
    if (this._server) {
        ...
        delete servers[this._nativeServer];
...
Server.prototype._on_new_request = function(args) {
    var requestContext = {
        ...
        uv_httpsys_server: args.uv_httpsys_server,
        asyncPending: false,
        requestRead: false,
        server: this,
        headers: {}
...
Server.prototype._on_written = function(args) {
    var requestContext = this._getRequestContext(args);
    requestContext.asyncPending = false;
